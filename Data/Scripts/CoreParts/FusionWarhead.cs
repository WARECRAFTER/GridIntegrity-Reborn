...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition FusionWarhead => new WeaponDefinition
        {
            ...
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "FusionExplosion",
                        SpinPartId = "None",
                        MuzzlePartId = "None",
                        AzimuthPartId = "None",
                        ElevationPartId = "None",
                        PhantomModel = "\\Models\\Cubes\\small\\ExplosionCore.mwm",
                    },
                },
                Muzzles = new[] {
                    "None",
            ...
            {
                PartName = "FusionExplosion", // name of weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons)
                ...
                HardWare = new HardwareDef
                {
                    ...
                    CriticalReaction = new CriticalDef
                    {
                        ...
                        AmmoRound = "WARE_FusionExplosion",
                    },
                },
                Other = new OtherDef
                {
            ...
            Ammos = new[] {
                WARE_FusionExplosion,// must list primary, shrapnel and pattern ammos
            },
